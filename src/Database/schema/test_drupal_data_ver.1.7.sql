...
CREATE TABLE `curriculums` (
  ...
  `curriculum_basis` varchar(60) DEFAULT NULL,
...
INSERT INTO `curriculums` (`curriculum_uid`, `curriculum_no`, `curriculum_isLock`, `curriculum_yearCreated`, `curriculum_schoolYearCreated`, `curriculum_basis`, `program_uid`) VALUES
(1,	'2009-001',	'NO',	'2020',	'2020-2021',	'CMO 25, s. 2015',	1),
(3,	'2018-001',	'NO',	'2018',	'2019-2020',	'CMO 25, s. 2015',	1);
...
DROP TABLE IF EXISTS `requested_subjects`;
CREATE TABLE `requested_subjects` (
  `reqSubj_uid` int(255) NOT NULL AUTO_INCREMENT,
  `reqSubj_requestType` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `reqSubj_year` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `reqSubj_sem` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `reqSubj_subjectUID` int(255) NOT NULL,
  `reqSubj_studentIdNum` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`reqSubj_uid`),
  KEY `reqSubj_subjectUID` (`reqSubj_subjectUID`),
  KEY `reqSubj_studentUID` (`reqSubj_studentIdNum`),
  CONSTRAINT `requested_subjects_ibfk_1` FOREIGN KEY (`reqSubj_subjectUID`) REFERENCES `subjects` (`subject_uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `requested_subjects` (`reqSubj_uid`, `reqSubj_requestType`, `reqSubj_year`, `reqSubj_sem`, `reqSubj_subjectUID`, `reqSubj_studentIdNum`) VALUES
(1,	'requested',	'first-year',	'first-sem',	15,	'2018-0116'),
(2,	'requested',	'first-year',	'first-sem',	79,	'2018-0116'),
(3,	'requested',	'first-year',	'first-sem',	80,	'2018-0116'),
(4,	'requested',	'first-year',	'first-sem',	19,	'2018-0116'),
(5,	'requested',	'first-year',	'first-sem',	19,	'2018-0116');
...
CREATE TABLE `students_subjects` (
  ...
  `studSubj_isRequested` varchar(25) NOT NULL,
...
INSERT INTO `students_subjects` (`studSubj_uid`, `student_uid`, `subject_uid`, `studSubj_remarks`, `studSubj_finalRemarks`, `studSubj_isRequested`) VALUES
(22,	3,	47,	'2',	'2',	''),
(23,	3,	24,	'3',	'3',	''),
(24,	3,	15,	'1.50',	'1.50',	''),
(27,	3,	52,	'1.50',	'1.50',	''),
...
(5,	'John Rhee',	'Cortina',	'Chillos',	20,	'male',	5);
